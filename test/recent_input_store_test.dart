...
void main() {
  ...
  test('histories enforce their limits', () async {
    ...
    expect(prompts.first, 'Prompt 34');
    expect(prompts.last, 'Prompt 3');
  });
}
